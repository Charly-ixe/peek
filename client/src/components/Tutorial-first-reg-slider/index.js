...
export default Vue.extend({
  ...
  mounted () {
    ...
    this.slides.forEach((slide, i) => {
      slide.index = i
      slide.image = content.tuto_first_reg_steps[i].image
      slide.title = content.tuto_first_reg_steps[i].title
      slide.subtitle = content.tuto_first_reg_steps[i].subtitle
    })
